...
---@param cchBufSize integer? size of the buffer for pszBuf; if nil then the buffer will be NULL
...
---@param cbBuf integer? size of the buffer for buf; if nil then the buffer will be NULL
